...
#
# Supports paired-end, single-end, and long-read (PacBio HiFi) modes.
...
tryCatch({
  ...
  # Discover FASTQ files (single-end only for long reads)
  ...
  # ── Step 1: Filter (length filtering, no truncation) ───────────────────
  ...
  # ── Step 4: Sequence Table + Chimera Removal ───────────────────────────
